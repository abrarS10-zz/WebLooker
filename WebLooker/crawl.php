...
function createLink($src, $url) {
	...
	$host = parse_url($url)["host"];     //www.something.com
	//handle cases of different URLs
	if(substr($src, 0, 2) == "//") {
		$src = $scheme . ":" . $src;
	}
...
function followLinks($url) {
	...
	//link contains each iteration of linkList during each loop
